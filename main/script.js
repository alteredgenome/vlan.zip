...
navigationLink.click(function(e){
  if ($(this).hasClass('out')) {
    redirect('http://instagram.com/arcticben.co.uk');
  }else
  {
  createHome();
  }
	...
	$(search_form).submit(function( event ) {
	  if ( 'aboutmenull' === $( "input" ).val() || 'codelabnull' === $( "input" ).val() ||  'contactnull' === $( "input" ).val() || 'gethackednull' === $( "input" ).val() || 'blognull' === $( "input" ).val() || 'home'  === $( "input" ).val()) {

    createHome();

	  } else if ( $( "input" ).val() === "blog" ) {
				redirect('../blog/index.html');
  		} else if ( $( "input" ).val() === "linkedin" ) {
				redirect('https://linkedin.com/in/netswitcher');
        } else if ( $( "input" ).val() === "about" ) {
				redirect('about.html');
        } else if ( $( "input" ).val() === "credits" ) {
				redirect('credits.html');
        } else if ( $( "input" ).val() === "resume" ) {
				redirect('resume.pdf');
        } else if ( $( "input" ).val() === "play" ) {
				var bgAudio = document.getElementById("bgAudio")
                bgAudio.play();
        } else if ( $( "input" ).val() === "pause" ) {
				var bgAudio = document.getElementById("bgAudio")
                bgAudio.pause();
        }
